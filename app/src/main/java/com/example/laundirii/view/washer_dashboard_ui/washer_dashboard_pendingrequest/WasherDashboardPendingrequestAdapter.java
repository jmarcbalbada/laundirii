...
//        holder.textViewOrderId.setText("Order ID: " + order.getOrderID() +"-- Order Status: " + order.getPhase1OrderStatus()  );
        ...
        holder.textViewLaundryWeight.setText("Initial Laundry Weight : "+ order.getInitialLoad());
        holder.textViewCourierStatus.setText("Pending Waiting For Approval");
        holder.textViewPendingBalance.setText("Expected to earn : " + (order.getInitialLoad() * order.getWasher().getRatePerKg()));
    }
